...
import { cambiarMiPassword, cambiarMiUsuario, cambiarMiNombre } from "./acciones";
...
export function FormulariosPerfil({
  ...
  return (
    <div className="flex flex-col gap-11">
      <section>
        <h2 className="mb-1 font-semibold">Mi nombre</h2>
        <p className="mb-5 text-sm text-tinta-suave">
          Es el que aparece en la pantalla de acceso, para no tener que reconocerse por el usuario.
        </p>
        <Formulario accion={cambiarMiNombre} boton="Guardar nombre">
          <Campo etiqueta="Nombre" nombre="nombre" valor={nombreActual} requerido />
        </Formulario>
      </section>
